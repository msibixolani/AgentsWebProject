 ...
 * @author Xolani Msibi
 */
public class GetStatusByGenderServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Agents> list = afl.getByStatus(status, gender);
        request.setAttribute("gender", String.valueOf(gender));
        request.setAttribute("list", list);
        request.setAttribute("status", status);
        
        RequestDispatcher disp = request.getRequestDispatcher("get_by_status.jsp");
