 ...
 * @author Xolani Msibi
 */
public class GetByGenderServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Agents> list = afl.getByGender(gender);
        request.setAttribute("gender", String.valueOf(gender));
        request.setAttribute("list", list);
        
        RequestDispatcher disp = request.getRequestDispatcher("get_by_gender.jsp");
