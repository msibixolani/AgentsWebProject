 ...
 * @author Xolani Msibi
 */
public class GetByAgeServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Agents> list = afl.getAgeByGender(minAge, maxAge, gender);
        ...
        RequestDispatcher disp = request.getRequestDispatcher("get_by_age.jsp");
