...
<html>
    ...
    <body>
        ...
        <%
            ...
            Integer min = (Integer)request.getAttribute("minAge");
            Integer max = (Integer)request.getAttribute("maxAge");
        ...
        <%
            ...
            count++;
                Agents a = list.get(i);
                Long id = a.getId();
                String stat = a.getMaritalStatus();
            String name = a.getName();
            Integer age = a.getAge();
            Date dob = a.getDateOfBirth();
                if(a.getGender() == gender && a.getAge() >= min && a.getAge() <= max)
                {
                id = a.getId();
                name = a.getName();
                age = a.getAge();
        ...
        <p>
            There are <%=count%> agents in the age of <%=min%> - <%=max%>
        </p>
        <ol>
